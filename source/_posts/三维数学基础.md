...
- 等式两边同左乘$\begin{bmatrix}e_1^T\\e_2^T\\e_3^T\end{bmatrix}\begin{bmatrix}$，由于e有性质：
  - $e_1^T\cdot e_1=1$
  - $e_1^T\cdot e_2=0$
  - $\begin{bmatrix}e_1^T\\e_2^T\\e_3^T\end{bmatrix}\begin{bmatrix}\begin{bmatrix}   e_1,e_2,e_3\end{bmatrix}\begin{bmatrix}=I$
